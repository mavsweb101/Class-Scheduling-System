...
include('../files/includes/dbcon.php');
	...
	foreach ($m as $daym){
		...
		{
			mysqli_query($con,"update schedule set time_id='$daym',day='m',subject_code='$subject',cys='$cys',room='$room',member_id='$member' where sched_id='$id'")or die(mysqli_error($con));
	...
	foreach ($t as $daym){
		...
		if (($count_t==0) and ($count_r==0) and ($count_c==0))
		{
			mysqli_query($con,"update schedule set time_id='$daym',day='t',subject_code='$subject',cys='$cys',room='$room',member_id='$member' where sched_id='$id'")or die(mysqli_error($con));
	...
	foreach ($w as $daym){
		...
		if (($count_t==0) and ($count_r==0) and ($count_c==0))
		{
			mysqli_query($con,"update schedule set time_id='$daym',day='w',subject_code='$subject',cys='$cys',room='$room', where sched_id='$id'")or die(mysqli_error($con));
	...
	foreach ($th as $daym){
		...
		if (($count_t==0) and ($count_r==0) and ($count_c==0))
		{
			mysqli_query($con,"update schedule set time_id='$daym',day='th',subject_code='$subject',cys='$cys',room='$room',member_id='$member' where sched_id='$id'")or die(mysqli_error($con));
	...
	foreach ($f as $daym){
		...
		if (($count_t==0) and ($count_r==0) and ($count_c==0))
		{
			mysqli_query($con,"update schedule set time_id='$daym',day='f',subject_code='$subject',cys='$cys',room='$room',member_id='$member' where sched_id='$id'")or die(mysqli_error($con));
