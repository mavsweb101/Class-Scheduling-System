...
CLASS <?php echo strtoupper($rows['term']);?> EXAM SCHEDULE</br>
	...
	<h5 align="center" style="margin-top: -15px;margin-bottom: 10px">
		<span style="margin-right: 5px">Class: </span>
		<span style="color: blue;margin-right: 15px"><?php echo $class;?></span>
							  ...
							  <tr>
								...
								where exam_sched.cys='$class'and settings_id='$sid' or exam_sched.cys1='$class' order by day,time_start")or die(mysqli_error($con));
									...
									<tr class="show">
										...
										<td><?php echo $row1['member_last'].", ".$row1['member_first']." ".$row1['member_middle'][0].".";?></td>
