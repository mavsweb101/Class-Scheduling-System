...
<html>
  <head>
    ...
    <title>Settings | <?php include('../files/includes/title.php');?></title>
  ...
  <body class="hold-transition skin-yellow layout-top-nav" onload="myFunction()">
    <div class="wrapper">
      <?php 
		include('../files/includes/nav.php');
	  ?>
      <!-- Full Width Column -->
    ...
    <?php
        ...
        $query=mysqli_query($con,"select * from settings order by sy asc")or die(mysqli_error());
