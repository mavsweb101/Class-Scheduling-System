...
<html>
  <head>
    ...
    <title>Exam | <?php include('../files/includes/title.php');?></title>
  ...
  <body class="hold-transition skin-yellow layout-top-nav" onload="myFunction()">
              ...
              <div class="box box-success">
               <form method="post" id="reg-form">
            	...
            	<h4>Print Class Schedule
              	<a href="#examt" data-target="#examt" data-toggle="modal" class="dropdown-toggle btn btn-info">Teacher</a>
				<a href="#examclass" data-target="#examclass" data-toggle="modal" class="dropdown-toggle btn btn-success">Class</a>
				<a href="#examroom" data-target="#examroom" data-toggle="modal" class="dropdown-toggle btn btn-warning">Room</a>
	...
	<div class="modal-dialog">
	  <div class="modal-content" style="height:auto">
			  ...
			  <form class="form-horizontal" method="post" action="faculty_exam.php">
 ...
 <div id="examclass" class="modal fade in" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
	<div class="modal-dialog">
	  <div class="modal-content" style="height:auto">
              ...
              <div class="modal-body">
			  <form class="form-horizontal" method="post" action="class_exam.php">
 ...
 <div id="examroom" class="modal fade in" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
	<div class="modal-dialog">
	  <div class="modal-content" style="height:auto">
              ...
              <div class="modal-body">
			  <form class="form-horizontal" method="post" action="room_exam.php">
