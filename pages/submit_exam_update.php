...
include('../files/includes/dbcon.php');
	...
	foreach ($f as $daym){
		...
		{
			mysqli_query($con,"update exam_sched set time_id='$daym',day='first',subject_code='$subject',cys='$cys',room='$room',member_id='$member' where sched_id='$id'")or die(mysqli_error($con));
	...
	foreach ($s as $daym){
		...
		if (($count_t==0) and ($count_r==0) and ($count_c==0))
		{
			mysqli_query($con,"update exam_sched set time_id='$daym',day='second',subject_code='$subject',cys='$cys',room='$room',member_id='$member' where sched_id='$id'")or die(mysqli_error($con));
	...
	foreach ($t as $daym){
		...
		if (($count_t==0) and ($count_r==0) and ($count_c==0))
		{
			mysqli_query($con,"update exam_sched set time_id='$daym',day='third',subject_code='$subject',cys='$cys',room='$room',member_id='$member' where sched_id='$id'")or die(mysqli_error($con));
