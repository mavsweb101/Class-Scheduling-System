...
include('../files/includes/dbcon.php');
	...
	foreach ($m as $daym){
		...
		{
			mysqli_query($con,"INSERT INTO schedule(time_id,day,member_id,subject_code,cys,room,settings_id,encoded_by) 
				VALUES('$daym','m','$member','$subject','$cys','$room','$set_id','$program')")or die(mysqli_error());
	...
	foreach ($t as $daym){
		...
		{
			mysqli_query($con,"INSERT INTO schedule(time_id,day,member_id,subject_code,cys,room,settings_id,encoded_by) 
				VALUES('$daym','t','$member','$subject','$cys','$room','$set_id','$program')")or die(mysqli_error($con));
	...
	foreach ($w as $daym){
		...
		{
			mysqli_query($con,"INSERT INTO schedule(time_id,day,member_id,subject_code,cys,room,settings_id,encoded_by) 
				VALUES('$daym','w','$member','$subject','$cys','$room','$set_id','$program')")or die(mysqli_error());
	...
	foreach ($th as $daym){
		...
		{
			mysqli_query($con,"INSERT INTO schedule(time_id,day,member_id,subject_code,cys,room,settings_id,encoded_by) 
				VALUES('$daym','th','$member','$subject','$cys','$room','$set_id','$program')")or die(mysqli_error());
	...
	foreach ($f as $daym){
		...
		{
			mysqli_query($con,"INSERT INTO schedule(time_id,day,member_id,subject_code,cys,room,settings_id,encoded_by) 
				VALUES('$daym','f','$member','$subject','$cys','$room','$set_id','$program')")or die(mysqli_error());
