...
<html>
  <head>
    ...
    <title>Signatories | <?php include('../files/includes/title.php');?></title>
		...
		<div class="col-md-6">
            ...
            <div class="col-md-3">
              ...
              <table style="font-style: italic;">
                ...
                <tr>
                  <td><b>1</b> Prepared by <b>(Person In-charge)</b></td>
                </tr>
                <tr>
                  <td><b>2</b> Approved <b>(Person In-charge)</b></td>
                </tr>
              </table><hr>
              <h4>Add Signatories</h4>
                  ...
                  include('../files/includes/dbcon.php');
								  ...
								  ?>
										<option value="<?php echo $row['member_id'];?>"><?php echo ucfirst($row['member_last'].", ".$row['member_first'])." ".ucfirst($row['member_middle'][0]).".";?></option>
								  <?php }
