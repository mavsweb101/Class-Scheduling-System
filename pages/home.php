...
<html>
  <head>
    ...
    <title>Class Sched | <?php include('../files/includes/title.php');?></title>
		...
		<div class="col-md-9">
            ...
            <div style="text-align:center">
            	<h4>Print Class Schedule
              	<a href="#searcht" data-target="#searcht" data-toggle="modal" class="dropdown-toggle btn btn-info">Teacher</a>
				<a href="#searchclass" data-target="#searchclass" data-toggle="modal" class="dropdown-toggle btn btn-success">Class</a>
				<a href="#searchroom" data-target="#searchroom" data-toggle="modal" class="dropdown-toggle btn btn-warning">Room</a>
                </h4><div class="result" id="form"></div>
            </div>
	...
	<div class="box-body">
		...
		<div class="col-md-6">
			...
			<thead>
				...
				<?php
					include('../files/includes/dbcon.php');
					$query=mysqli_query($con,"select * from time where days='_mtwthf' order by time_start")or die(mysqli_error());
		...
		<div id="form1">
			<div class="row">
				<div class="col-md-12">
						...
						<label for="date">Teacher</label>
							<select class="form-control select2" name="teacher" required>
								...
								<?php 
								 ...
								 ?>
								<option value="<?php echo $row['member_id'];?>"><?php echo $full_name;?></option>
								<?php } ?>
							</select>							
					</div><!-- /.form group -->
					<div class="form-group">
						<label for="date">Course, Year & Section</label>
					...
					<div class="form-group">
						<button class="btn btn-lg btn-primary" id="daterange-btn" name="save" type="submit">Save</button>
			...
			<div class="modal-content" style="height:auto">
				<div class="modal-header">
					...
					<div class="modal-body">
						<form class="form-horizontal" method="post" action="faculty_sched.php">
							<div class="form-group">
			...
			<div class="modal-content" style="height:auto">
				<div class="modal-header">
					...
					<h4 class="modal-title">Search Class Schedule</h4>
						...
						<div class="modal-body">
							<form class="form-horizontal" method="post" action="class_sched.php">
								<div class="form-group">
		...
		<div class="modal-dialog">
			<div class="modal-content" style="height:auto">
				<div class="modal-header">
					...
					<div class="modal-body">
						<form class="form-horizontal" method="post" action="room_sched.php">
							<div class="form-group">
