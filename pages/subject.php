...
<html>
  <head>
    ...
    <title>Subject | <?php include('../files/includes/title.php');?></title>
            ...
            <div class="col-md-3">
              <div class="box box-success">
					 ...
					 <div class="col-md-12">
						  ...
						  <div class="form-group">
							<label for="date">Add Subject</label><br>
								...
								<input type="text" class="form-control" name="title" placeholder="Descriptive Title" required>
						  </div><!-- /.form group -->
					</div>
				  </div>	
                ...
                <input type="hidden" class="form-control" id="id" name="id" value="<?php echo $_REQUEST['id'];?>">
								...
								<input type="text" class="form-control" id="class" name="title" value="<?php echo $_REQUEST['title'];?>" placeholder="Descriptive Title" required>
