...
<hr><br><br><br><br><br><br>
	      ...
	      <div class="col-md-9">
              ...
              <div style="text-align: center">
                ...
                </div><div class="result" id="form"></div> 
		...
		?>
							  <tr >
								...
								<?php if(($id==$time_id) and ($day=='m')) echo "checked"; ?>></td>
								  ...
								  <?php 
									$query2=mysqli_query($con,"select * from member order by member_last")or die(mysqli_error($con));
									  while($row2=mysqli_fetch_array($query2)){
										$db_first_name = $row2['member_first'];
										$db_middle_name = $row2['member_middle'];
										$db_last_name = $row2['member_last'];
										$full_name = ucfirst($db_last_name).", ".ucfirst($db_first_name)." ".ucfirst($db_middle_name[0]).".";
								  ?>
										<option value="<?php echo $row2['member_id'];?>"><?php echo $full_name;?></option>
								  <?php }
